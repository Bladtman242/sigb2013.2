import numpy as np
import SIGBToolsForSecond
import cv2
from SIGBToolsForSecond import Camera
...
def calibrationExample():
    ...
    calibrated, camera_matrix,dist_coefs,rms = SIGBToolsForSecond.calibrateCamera(camNum,nPoints,patternSize,saveImage)
    K = camera_matrix
